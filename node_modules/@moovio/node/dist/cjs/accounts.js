...
class Accounts {
    ...
    update(account) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.patch(account);
            throw new Error("update call for accounts is deprecated, please use the patch call.");
        });
    }
    /**
     ...
     * @tag Accounts
     */
    assignCountries(accountID, countries) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, checks_js_1.checkString)(accountID).or(errors_js_1.Err.MISSING_ACCOUNT_ID);
