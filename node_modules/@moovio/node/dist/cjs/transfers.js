...
class Transfers {
     ...
     *
     */
    create(transfer, idempotencyKey) {
     ...
     * }
     */
    updateMetadata(transferID, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, checks_js_1.checkString)(transferID).or(errors_js_1.Err.MISSING_TRANSFER_ID);
            const result = yield this.moov
                .got({
     ...
     * }
     */
    getTransferOptions(transferOptionsCriteria) {
        return __awaiter(this, void 0, void 0, function* () {
